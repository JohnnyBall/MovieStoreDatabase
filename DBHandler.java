...
public class DBHandler
{
    ...
    public DBHandler()
    {
        ...
        acquireResults2ElectricBugalooMovies = "SELECT DISTINCT Rental1.rid as Rental_Id , Rental1.title as RentalTitle, Rental1.releaseDate as ReleaseDate, Rental1.num_availible_copys as AmountAvaliable, Genr.Genres,CastMember.CastMembers, Director.Director " +
                                               "FROM "+
        ...
        acquireResults     = "SELECT DISTINCT * "+
                             "FROM rentals ar " +
                             "WHERE ar.rid IN (";
